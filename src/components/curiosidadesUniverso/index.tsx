...
export default function CuriosidadesUniverse() {
  return (
    <section className="flex items-center justify-center h-[50vh] w-full">
      <div className="flex flex-col gap-20 items-center justify-start max-w-[1996px] w-[90%] h-full ">
        <div className="w-full flex items-end justify-center ">
          <h1 className="md:text-6xl text-center flex items-center justify-center md:w-full w-[70%] text-2xl text-black dark:text-white font-bold">
        ...
        <div className=" w-full h-full flex justify-center items-start ">
          <div className="flex flex-col justify-center items-center w-1/4  h-full">
            <div className="flex w-full gap-5 h-1/2">
              <div className="flex items-center justify-center shadow text-3xl font-bold text-white w-20 h-16 sha bg-[#4271D0] rounded-full">
                1
              </div>
          ...
          <div className="flex flex-col justify-center items-center w-1/4  h-full">
            <div className="flex w-full gap-5 h-1/2">
              <div className="flex items-center justify-center text-3xl shadow font-bold text-white w-20 h-16 sha bg-[#4271D0] rounded-full">
                3
              </div>
              <div className="flex-col w-full h-full">
                <h2 className="text-2xl font-bold dark:text-white text-black">
            ...
            <div className="flex w-full gap-5 ">
              <div className="flex items-center justify-center text-3xl font-bold shadow text-white w-20 h-16 sha bg-[#4271D0] rounded-full">
                4
              </div>
              <div className="flex-col w-full h-auto">
                <h2 className="text-2xl font-bold dark:text-white text-black">
